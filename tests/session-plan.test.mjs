...
import {normalizeLayout,paginateSession,moveSessionItem,buildSessionProgression,sessionItemKey} from '../src/session-plan.js';
...
assert.equal(sessionItemKey({answer:'Cinéma',activity:{id:'oral-to-written'}}),'cinema::oraltowritten');
assert.notEqual(sessionItemKey({answer:'merci',activity:{id:'syllable-blending'}}),sessionItemKey({answer:'merci',activity:{id:'oral-to-written'}}));
