...
import {buildDrawableOpportunityShortlist,buildExpansionCurationLeads} from '../src/drawable-opportunities.js';
...
const expansionCurationLeads=buildExpansionCurationLeads(opportunities,seed,{limit:20});
...
console.log(`Opportunities: ${opportunities.length} ranked attested whole-word sound blocks; ${drawableShortlist.length} drawable-review candidates; ${expansionCurationLeads.length} uncurated leads.`);
