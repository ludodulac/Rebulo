...
import {OPEN_PICTOGRAMS_WAVE_4} from './open-pictogram-library-wave4.js';

export const PICTOGRAMS_PER_PRINT_PAGE=20;
export const PRINT_COLUMNS=4;
export const PRINT_ROWS=5;
export const ALL_OPEN_PICTOGRAMS=Object.freeze([...OPEN_PICTOGRAMS,...OPEN_PICTOGRAMS_WAVE_2,...OPEN_PICTOGRAMS_WAVE_3,...OPEN_PICTOGRAMS_WAVE_4]);
