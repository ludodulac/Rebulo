...
export function buildIndexedPictograms(items=OPEN_PICTOGRAMS){
  const seen=new Set();
...
export function paginatePictograms(items=OPEN_PICTOGRAMS,perPage=PICTOGRAMS_PER_PRINT_PAGE){
...
export function buildPrintSheetPairs(items=OPEN_PICTOGRAMS){
...
export function pictogramIndexCsv(items=OPEN_PICTOGRAMS){
...
export function printLibraryMeta(items=OPEN_PICTOGRAMS){
  const indexed=buildIndexedPictograms(items);
