...
try{
  ...
  await page.addInitScript(()=>{
    ...
    document.addEventListener('DOMContentLoaded',()=>{const rebus=document.querySelector('#creatorRebus');if(rebus)new MutationObserver(()=>snap('rebus.mutation')).observe(rebus,{childList:true,subtree:true,characterData:true});const resultWord=document.querySelector('#resultWord');if(resultWord)new MutationObserver(()=>snap('resultWord.mutation')).observe(resultWord,{childList:true,subtree:true,characterData:true});},{once:true});
  });
