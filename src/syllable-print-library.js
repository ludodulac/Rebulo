export const SYLLABLE_PRINT_LIBRARY=Object.freeze([
  ...
  {id:'scie',label:'scie',ipa:'/si/',image:'assets/visible-batch1/individual/scie.png',status:'active'},
  {id:'nez',label:'nez',ipa:'/ne/',image:'assets/visible-batch1/individual/nez.png',status:'active'},
  ...
  {id:'de',label:'dé',ipa:'/de/',image:'assets/visible-batch1/individual/de.png',status:'active'},
  ...
  {id:'riz',label:'riz',ipa:'/ʁi/',image:'assets/visible-batch1/individual/riz.png',status:'active'},
